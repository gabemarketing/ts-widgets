(function () {
    ...
    const WIDGET_ID = "adv-fac-cards";

    const WIDGET_CSS = `
.ms-fac-cards .facility-widget {
  width: 100%;
  padding: 20px 0;
}
.ms-fac-cards .facility-columns-container {
  display: flex;
  gap: 20px;
  align-items: stretch;
}
.ms-fac-cards .facility-columns-container.stacked-horizontally {
  flex-direction: row;
}
.ms-fac-cards .facility-columns-container.stacked-vertically {
  flex-direction: column;
  align-items: center;
}
.ms-fac-cards .facility-columns-container.wrap-enabled {
  flex-wrap: wrap;
  justify-content: center;
}
.ms-fac-cards .facility-columns-container.wrap-disabled {
  flex-wrap: nowrap;
  justify-content: center;
}
.ms-fac-cards .facility-column {
  min-width: 250px;
  max-width: 350px;
  background: #ffffff;
  border-radius: 8px;
...
.ms-fac-cards .facility-columns-container.wrap-enabled .facility-column {
  flex: 0 0 auto;
}
.ms-fac-cards .facility-columns-container.wrap-disabled .facility-column {
  flex: 0 1 auto;
}
.ms-fac-cards .facility-image-container {
  width: 100%;
  height: 200px;
  overflow: hidden;
  position: relative;
...
.ms-fac-cards .facility-image {
  width: 100%;
  height: 100%;
  object-fit: cover;
  transition: transform 0.3s ease;
}
.ms-fac-cards .facility-content {
  padding: 20px;
  display: flex;
  flex-direction: column;
  flex-grow: 1;
...
.ms-fac-cards .facility-debug-info {
...
.ms-fac-cards .facility-debug-info .debug-item {
  margin: 5px 0;
  color: #495057;
  word-break: break-word;
}
.ms-fac-cards .facility-debug-info .debug-item strong {
  color: #212529;
  font-weight: 600;
}
.ms-fac-cards .facility-buttons {
  display: flex;
  flex-direction: column;
  gap: 10px;
  margin-top: auto;
...
.ms-fac-cards .facility-link-button,
.ms-fac-cards .facility-phone-button {
...
.ms-fac-cards .facility-link-button:hover {
...
.ms-fac-cards .facility-phone-button:hover {
  background-color: #007cba;
  color: white !important;
}
.ms-fac-cards .no-facilities-message {
  text-align: center;
  padding: 40px 20px;
  color: #666;
  font-size: 1.1rem;
...
.ms-fac-cards .facility-pagination-controls {
  display: flex;
  flex-wrap: wrap;
  justify-content: center;
  align-items: center;
...
.ms-fac-cards .pagination-btn:hover:not(:disabled) {
  background-color: #333333;
}
.ms-fac-cards .pagination-btn:disabled {
  background-color: #ccc;
  cursor: not-allowed;
  opacity: 0.6;
}
.ms-fac-cards .pagination-numbers {
  display: flex;
  flex-wrap: wrap;
  gap: 5px;
  justify-content: center;
}
.ms-fac-cards .pagination-number {
  padding: 8px 12px;
...
.ms-fac-cards .pagination-number:hover {
  background-color: #e0e0e0;
}
.ms-fac-cards .pagination-number.active {
  background-color: #555555;
  color: white;
  border-color: #555555;
  font-weight: 600;
